      ...
      <div class="pricing-plan hide">
        ...
        <div class="pricing-price-block yearly-text">
          <div class="pricing-price-block">
            <a class="pricing-price"><span class="fancy-strike">$199</span><br>$166<span class="pricing-price-small">.... / mo.. / 月....<br>....Total $1,999 billed annually..每年支付 $1,999....<br></span></a>
            <a id="silver-yearly" href="https://app.acuityscheduling.com/catalog.php?owner=15731779&action=addCart&clear=1&id=905611" target="_blank" class="acuity-embed-button pricing-button is-featured">....Buy Now..购买年卡....</a>
          </div>
        </div> -->
        <!-- MONTHLY PRICING -->
        <div class="monthly-text hide">
          <div class="pricing-price-block">
            ...
            <a id="silver-monthly" href="https://app.acuityscheduling.com/catalog.php?owner=15731779&action=addCart&clear=1&id=905606" target="_blank" class="acuity-embed-button pricing-button">....Buy Now..购买月卡....</a>
          </div>
        </div>
      </div>
      ...
      <div class="pricing-plan">
        ...
        <div class="yearly-text">
          <div class="pricing-price-block">
            ...
            <a id="gold-yearly" href="https://app.acuityscheduling.com/catalog.php?owner=15731779&action=addCart&clear=1&id=905610" target="_blank" class="acuity-embed-button pricing-button is-featured-gold">....Buy Now..购买年卡....</a>
          </div>
        </div>
        <!-- MONTHLY PRICING -->
        <div class="monthly-text hide">
          <div class="pricing-price-block">
            ...
            <a id="gold-monthly" href="https://app.acuityscheduling.com/catalog.php?owner=15731779&action=addCart&clear=1&id=905608" target="_blank" class="acuity-embed-button pricing-button-gold">....Buy Now..购买月卡....</a>
          </div>          
        </div>
      </div>
      ...
      <div class="pricing-plan">
        ...
        <div class="yearly-text">
          <div class="pricing-price-block">
            ...
            <a id="16-class" href="#" target="_blank" class="acuity-embed-button pricing-button is-featured">....16 Class..16课程....</a>
            <a id="8-class" href="#" target="_blank" class="acuity-embed-button pricing-button is-featured">....8 Class..8课程....</a>
          </div>
        </div>
        <!-- 8 CLASS -->
        <div class="monthly-text hide">
          <div class="pricing-price-block">
            <a class="pricing-price pricing-price-medium">....16 Classes $419..16节课程 $419....<br><span class="pricing-price-small">....Good for 4 months..4个月有效期....<br></span>....8 Classes $259..8节课程 $259....<br><span class="pricing-price-small">....Good for 2 months..2个月有效期....<br></span></a>
            <a id="16-class" href="https://app.acuityscheduling.com/catalog.php?owner=15731779&action=addCart&clear=1&id=930225" target="_blank" class="acuity-embed-button pricing-button">....16 Class..16课程....</a>
            <a id="8-class" href="https://app.acuityscheduling.com/catalog.php?owner=15731779&action=addCart&clear=1&id=905655" target="_blank" class="acuity-embed-button pricing-button">....8 Class..8课程....</a>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  // Populate DDY URLs for packages and memberships based on location
  // Set URL variables from Acuity
  var ddyURLs = {
    taiSeng: {
  ...
  // Populate href attr values with proper URL
  var $8class = $('#8-class'),
      $16class = $('#16-class'),
      $silverYearly = $('#silver-yearly'),
      $silverMonthly = $('#silver-monthly'),
      $goldYearly = $('#gold-yearly'),
      $goldMonthly = $('#gold-monthly');

  $8class.attr('href', ddyURLs[loc].eightClassPackage);
  $16class.attr('href', ddyURLs[loc].sixteenClassPackage);
  $silverYearly.attr('href', ddyURLs[loc].silverYearly);
  $silverMonthly.attr('href', ddyURLs[loc].silverMonthly);
  $goldYearly.attr('href', ddyURLs[loc].goldYearly);
  $goldMonthly.attr('href', ddyURLs[loc].goldMonthly);
